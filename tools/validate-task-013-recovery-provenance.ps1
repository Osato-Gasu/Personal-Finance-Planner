...
function Assert-RecoveryProvenanceCore($Snapshot,[string]$Label) {
    ...
    $expectedRecoveryPaths = @('AGENTS.md','board/PROGRESS.html','docs/ai/BACKLOG.md','docs/ai/CURRENT_STATE.md','docs/ai/NEXT_ACTION.yml','docs/ai/PROJECT_ADAPTER.psd1','docs/ai/PROJECT_RULES.md','docs/ai/SHARED_RULES.lock.yml','docs/ai/SESSION_START.md','docs/ai/WORKFLOW.md','docs/ai/handoffs/TASK-013/IMPLEMENTATION_REVIEW_HANDOFF.md','docs/ai/tasks/TASK-013.md','tools/sync-shared-governance.ps1','tools/validate-project-overlay.ps1','tools/validate-task-013-recovery-provenance.ps1')
