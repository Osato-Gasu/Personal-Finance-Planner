...
**暮らしと資産プランナー**は、給与・手取り・家計・NISA・iDeCo・ライフプラン年間キャッシュフローを同じブラウザ内で試算するローカルファーストWebアプリです。
...
ライフプランは、保存した基準日の投資後手残りを固定して暦年へ展開し、登録した収入・支出イベントだけを加減算します。給与、税、社会保険、生活費、投資額、制度または運用成果の将来予測ではありません。
