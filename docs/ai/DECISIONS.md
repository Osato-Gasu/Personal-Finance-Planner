...
## GOV-017 TASK-009 review termination and TASK-013 transition

- TASK-009 spec revision 2 implementation review attempt 3／terminal／final ended in `NEEDS_USER_DECISION` at cycles 3 for candidate `03825e58f61f95d2364f09246f202744e4617ba5`（tree `934892b96eff8e5b66ddf67e71eefd29353a86a0`）. Termination commit `af6445bac2a982f9322a6a92ab75eca44edab043`（tree `bf49b6f6bdee5af1408592ac19d1dca8287d836c`）and Governance CI `31943234008` attempt 1／job `95155303904` succeeded.
- The user selected option A／`CREATE_SEPARATE_TASK` under approval `USER-DECISION-TASK-009-REMEDIATION-20260816-202947`. TASK-009 remains terminated and inactive, attempt 4 is forbidden, its candidate is not retroactively approved or released, and origin/main integration is not authorized.
- Unresolved `FINDING-009-V2-R1-02` remains a MAJOR security／release-gate finding: Actions run／job／artifact inventory uniqueness must be bound to canonical stable IDs independently from mutable metadata.
- Remediation moves to separate TASK-013, `TASK-009公開監査stable ID修復`. TASK-013 begins only after formal requirements are defined, at cycles 0／attempt 1／standard／final false／terminated false, and must create a new candidate and review without treating TASK-009 as approved.
- User-decision transition artifact: schema `project-user-decision-separate-task-transition-v1`, type `PORTABLE_USER_DECISION_SEPARATE_TASK_TRANSITION`, SHA-256 `557C4E1B26F153025D04B8403F68D3594D647AF994FA458C17ADB4892A4CD23C`, 14795 bytes.
- The TASK-009 task, handoff, report, canonical final-review relay, and unresolved finding remain traceable through termination commit `af6445bac2a982f9322a6a92ab75eca44edab043`; canonical `git_only` transition removes the inactive packet from the current tree without rewriting history.
