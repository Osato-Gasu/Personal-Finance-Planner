...
- historical_current_rejection: historical identityをcurrent fieldへ置くとFAIL
- commit_policy: candidate 18c3e67d3370fefc7ea00c9373bd37f7978395deを変更せずexact reviewする
