...
| --- | --- | --- | --- | --- | --- | --- | --- |
| TASK-004 | high | blocked | high | implementation_review | 手取り計算ベータ | TASK-002 | 最終レビュー打ち切り。未解消事項をTASK-010へ移管しmain未反映 |
...
| TASK-010 | high | ready | high | implementation_review | 65～74歳介護保険未計算安全化 | TASK-002 | 新candidateをimplementation review attempt 2／standardでexact reviewする |
<!-- PROGRESS:END -->
