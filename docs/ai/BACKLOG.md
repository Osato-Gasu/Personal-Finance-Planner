...
| TASK-009 | low | blocked | high | implementation_review | 配布 | TASK-008 | 最終レビュー打ち切り。candidate未承認・未release・attempt 4禁止・FINDING-009-V2-R1-02はTASK-013へ移管し、packetはGit履歴で監査する |
| TASK-013 | high | ready | high | requirements | TASK-009公開監査stable ID修復 | TASK-009 | ChatGPTが正式要件を定義する |
<!-- PROGRESS:END -->
