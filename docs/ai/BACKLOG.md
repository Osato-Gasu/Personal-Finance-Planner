...
| --- | --- | --- | --- | --- | --- | --- | --- |
| TASK-003 | high | ready | high | implementation_review | 家計・生活費MVP | TASK-002 | candidate exact SHAをattempt 3／relaxed／finalで実装レビューする |
...
| TASK-008 | normal | queued | high | requirements | データ保全・UX完成 | TASK-003,TASK-004,TASK-005,TASK-006,TASK-007 | migrationとimport安全条件を定義する |
